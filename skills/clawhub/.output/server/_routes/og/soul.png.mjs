import { R as Resvg2, i as initWasm } from "../../_chunks/_libs/@resvg/resvg-wasm.mjs";
import { e as defineEventHandler, g as getQuery, s as setHeader, f as getRequestHost } from "../../_libs/h3.mjs";
import { F as FONT_SANS, a as FONT_MONO, g as getMarkDataUrl, b as getFontBuffers, c as getResvgWasm } from "../../_chunks/ogAssets.mjs";
import "../../_libs/rou3.mjs";
import "../../_libs/srvx.mjs";
import "node:fs/promises";
import "node:url";
async function fetchSoulOgMeta(slug, apiBase) {
  try {
...
function buildSoulOgSvg(params) {
...
function buildFooter(slug, owner) {
  if (owner) return `@${owner}/${slug}`;
  return `souls/${slug}`;
}
const soul_png = defineEventHandler(async (event) => {
